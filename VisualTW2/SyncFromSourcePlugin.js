...
|''Requires''    |SyncPlugin|
|''Source''      |https://yakovl.github.io/VisualTW2/VisualTW2.html#SyncFromSourcePlugin|
|''Author''      |Pascal Collin|
|''Version''     |1.0.1|
|''Date''        |Nov 28, 2023|
|''License''     |[[BSD open source license|License]]|
!Usage
# install the [[SyncPlugin|https://github.com/TiddlyWiki/tiddlywiki/blob/master/plugins/Sync.js]] (recent versions of TW don't have sync out of the box).
# import this plugin (or copy it with the {{{systemConfig}}} tag), save and reload.
...
Look at this [[example|SyncFromSourceDemo]] on plugin [[homepage|https://yakovl.github.io/VisualTW2/VisualTW2.html]].
!Patch required for TiddlyWiki 2.3.0
A bug in TW 2.3.0 requires [[SyncPatch]].
!See also
[[ExtensionsExplorerPlugin|https://github.com/YakovL/TiddlyWiki_ExtensionsExplorerPlugin]] for automatic updates checking and more.
!Code
***/
//{{{
config.macros.sync.getSyncableTiddlersWithoutSource = config.macros.sync.getSyncableTiddlersWithoutSource || config.macros.sync.getSyncableTiddlers;

config.macros.sync.startSyncWithoutSource = config.macros.sync.startSyncWithoutSource || config.macros.sync.startSync;
